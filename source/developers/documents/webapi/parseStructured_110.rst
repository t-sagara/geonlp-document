.. _webapi_parseStructured_110:

================================================
parseStructured（バージョン1.1.0以前）
================================================
...
処理結果の構造化テキストを返す（ :ref:`webapi_parse_110` と同じ）。
構造化テキストは、 :ref:`json_geoword` 、 :ref:`json_address` 、元の文章中の文字列のいずれかを要素とする配列として出力される。

レスポンスの例
++++++++++++++++++++++++++++++++++++++++
.. literalinclude:: php/parseStructured_result_110.json
   :language: javascript
...
.. literalinclude:: php/parseStructured_result_110.txt
   :language: php
