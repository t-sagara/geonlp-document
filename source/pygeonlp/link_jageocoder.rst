...
.. code-block :: plaintext
  ...
  >>> jageocoder.init(f'sqlite:///{jageocoder_db_dir}/address.db', f'{jageocoder_db_dir}/address.trie')
  >>> api.init()
...
3. `api.get_jageocoder_db_dir() <pygeonlp.api.html#pygeonlp.api.get_jageocoder_db_dir>`_ を呼んで jageocoder の辞書ディレクトリを探します。
